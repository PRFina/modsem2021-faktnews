...
class RichSnippet extends Component {
  ...
  isTrustedSource(trustValue) {
    if (trustValue) {
      return (
        <span class="badge badge-success" style={{ verticalAlign: "text-top" }}>
          True{" "}
          <svg
      ...
      return (
        <span class="badge badge-warning" style={{ verticalAlign: "text-top" }}>
          False{" "}
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
      ...
      <p>
        {this.props.review.mention.map((element, index) => {
          ...
          return (
            <div class="card mb-3">
              <div class="card-body">
                <h5 class="card-title">{element_clean}</h5>
                <h6 class="card-subtitle mb-2 text-muted">Mentioned</h6>
                <p class="card-text">
